...
const Navbar = () => {
  ...
  const user = useSelector(state => state.user); // Assuming you have a user state for authentication
      ...
      <div className="container">
        ...
        <NavLink className="navbar-brand d-flex align-items-center fw-bold fs-4 px-2" to="/about">
          ...
          <span>
            ...
            <span style={{ color: '#ffcc00' }}>Kart</span> {/*yellow color*/}
          </span>
        </NavLink>
            ...
            {!user.isLoggedIn ? (
              ...
              <>
                <NavLink to="/profile" className="btn btn-outline-dark m-2">
                  <i className="fa fa-user-circle mr-1"></i> {user.name}'s Profile
                </NavLink>
